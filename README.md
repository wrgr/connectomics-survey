...
- **Protocol (current draft): [`docs/protocol/connectomics_bibliography_methodology_v4.md`](docs/protocol/connectomics_bibliography_methodology_v4.md)** — provenance reconciliation and registration decision: [`docs/IA-016-provenance-reconciliation.md`](docs/IA-016-provenance-reconciliation.md)
