...
# Rebuild package-verification metadata after the package has reached its final
# patched state. This intentionally does not inherit stale v0.1.1 test claims.
