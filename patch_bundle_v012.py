...
# Explicitly request 1000 records/page on bulk search, the endpoint maximum.
replace_once(
    client,
    '            params = {"query": query, "fields": self.paper_fields}\n',
    '            params = {"query": query, "fields": self.paper_fields, "limit": 1000}\n',
)
